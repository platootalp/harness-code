...
class TestSuspendManagerSetupRestore:
    ...
    def test_setup_installs_handler(self) -> None:
        ...
        mgr = SuspendManager()
        with patch("claude-code-py.cli.suspend.signal.signal") as mock_signal:
            mgr.setup()
...
class TestSuspendManagerResume:
    ...
    def test_resume_clears_suspended_flag(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.signal.signal"):
            mgr.resume()
        assert mgr.is_suspended is False
...
class TestSuspendManagerHandleSigstp:
    ...
    def test_handle_sigtstp_sets_flag(self) -> None:
        ...
        mgr = SuspendManager()
        with patch("claude-code-py.cli.suspend.signal.signal"), \
                patch("claude-code-py.cli.suspend.os.kill"):
    ...
    def test_handle_sigtstp_sends_sigstop(self) -> None:
        ...
        mgr = SuspendManager()
        with patch("claude-code-py.cli.suspend.signal.signal"), \
                patch("claude-code-py.cli.suspend.os.kill") as mock_kill, \
                patch("claude-code-py.cli.suspend.os.getpid", return_value=12345):
            mgr._handle_sigtstp(20, None)
...
class TestIsInteractive:
    ...
    def test_is_interactive_true_when_both_tty(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.sys.stdin") as mock_stdin, \
                patch("claude-code-py.cli.suspend.sys.stdout") as mock_stdout:
    ...
    def test_is_interactive_false_on_attribute_error(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.sys.stdin", None), \
                patch("claude-code-py.cli.suspend.sys.stdout", None):
            assert is_interactive() is False
    ...
    def test_is_interactive_false_on_value_error(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.sys.stdin", mock_stdin), \
                patch("claude-code-py.cli.suspend.sys.stdout", mock_stdout):
            assert is_interactive() is False
...
class TestSuspendProcess:
    ...
    def test_suspend_process_sends_sigstp(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.is_interactive", return_value=True), \
                patch("claude-code-py.cli.suspend.os.kill") as mock_kill, \
                patch("claude-code-py.cli.suspend.os.getpid", return_value=999):
            suspend_process()
    ...
    def test_suspend_process_noop_when_not_interactive(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.is_interactive", return_value=False), \
                patch("claude-code-py.cli.suspend.os.kill") as mock_kill:
            suspend_process()
    ...
    def test_suspend_process_noop_on_oserror(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.is_interactive", return_value=True), \
                patch("claude-code-py.cli.suspend.os.kill", side_effect=OSError()):
...
class TestSendToBackground:
    ...
    def test_send_to_background_returns_zero_on_success(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.is_interactive", return_value=True), \
                patch("claude-code-py.cli.suspend.os.getpid", return_value=999), \
                patch("claude-code-py.cli.suspend.os.getpgid", return_value=100), \
                patch("claude-code-py.cli.suspend.os.killpg"):
    ...
    def test_send_to_background_returns_minus_one_on_oserror(self) -> None:
        ...
        with patch("claude-code-py.cli.suspend.is_interactive", return_value=True), \
                patch("claude-code-py.cli.suspend.os.getpid", return_value=999), \
                patch("claude-code-py.cli.suspend.os.getpgid", side_effect=OSError()):
            result = send_to_background()
        assert result == -1
