...
class SQLiteSessionStorage:
    ...
    DEFAULT_DB_PATH: str = "~/.src/sessions.db"
    DEFAULT_ARTIFACTS_DIR: str = "~/.src/storage/artifacts"
    ...
    def __init__(
        ...
        Args:
            db_path: Path to SQLite database. Defaults to ~/.src/sessions.db.
            artifacts_dir: Directory for large content files.
                Defaults to ~/.src/storage/artifacts.
