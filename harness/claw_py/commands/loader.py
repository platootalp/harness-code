...
_BUILTIN_COMMAND_MODULES: list[str] = [
    "claw_py.commands.clear",
    "claw_py.commands.git",
    "claw_py.commands.exit",
    "claw_py.commands.files",
    "claw_py.commands.rewind",
    "claw_py.commands.vim",
    "claw_py.commands.cost",
    "claw_py.commands.stats",
    "claw_py.commands.status",
    "claw_py.commands.usage",
    "claw_py.commands.plan",
    "claw_py.commands.thinkback",
    "claw_py.commands.output_style",
    "claw_py.commands.privacy_settings",
    "claw_py.commands.rate_limit_options",
    "claw_py.commands.remote_env",
    "claw_py.commands.remote_setup",
    "claw_py.commands.tag",
    "claw_py.commands.sandbox_toggle",
    "claw_py.commands.terminal_setup",
    "claw_py.commands.extra_usage",
    "claw_py.commands.chrome",
    "claw_py.commands.mobile",
    "claw_py.commands.desktop",
    "claw_py.commands.install_github_app",
]
