...
_BUILTIN_COMMAND_MODULES: list[str] = [
    "claude-code-py.commands.clear",
    "claude-code-py.commands.git",
    "claude-code-py.commands.exit",
    "claude-code-py.commands.files",
    "claude-code-py.commands.rewind",
    "claude-code-py.commands.vim",
    "claude-code-py.commands.cost",
    "claude-code-py.commands.stats",
    "claude-code-py.commands.status",
    "claude-code-py.commands.usage",
    "claude-code-py.commands.plan",
    "claude-code-py.commands.thinkback",
    "claude-code-py.commands.output_style",
    "claude-code-py.commands.privacy_settings",
    "claude-code-py.commands.rate_limit_options",
    "claude-code-py.commands.remote_env",
    "claude-code-py.commands.remote_setup",
    "claude-code-py.commands.tag",
    "claude-code-py.commands.sandbox_toggle",
    "claude-code-py.commands.terminal_setup",
    "claude-code-py.commands.extra_usage",
    "claude-code-py.commands.chrome",
    "claude-code-py.commands.mobile",
    "claude-code-py.commands.desktop",
    "claude-code-py.commands.install_github_app",
]
