...
**Current:**
```json
"test": ["python -c \"import claude-code-py\""]
```
...
```json
"test": [
  "python -c \"import claude-code-py.models; import claude-code-py.engine; import claude-code-py.tools; print('OK')\"",
  "ls -la src_py/src/claude-code-py/"
]
```
