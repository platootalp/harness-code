---
name: agent-builder
description: Design and build AI agents for any domain. Use when users want to create agents, understand agent architecture, or build assistants. Keywords - agent, assistant, autonomous, workflow, tool use, orchestration.
---
