#!/usr/bin/env python3
"""
s_full_openai.py - Full Reference Agent (OpenAI API Format)
...
MODEL = os.environ.get("OPENAI_MODEL", os.environ.get("MODEL_ID", "gpt-4o"))
...
def run_subagent(prompt: str, agent_type: str = "Explore") -> str:
    ...
    sub_sys = "You are a helpful subagent. Use tools to complete the task."
    sub_msgs = [
...
def auto_compact(messages: list) -> list:
    ...
    sys_msg = "You are a helpful assistant that summarizes conversation history for continuity."
    resp = client.chat.completions.create(
        model=MODEL,
        messages=[
            ...
            for _ in range(50):
                ...
                for tc in msg.tool_calls:
                    ...
                    if tc.function.name == "idle":
                        ...
                        output = dispatch.get(tc.function.name, lambda **kw: "Unknown")(
                            **args
                        )
